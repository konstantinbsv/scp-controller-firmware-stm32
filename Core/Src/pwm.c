...
HAL_StatusTypeDef SetPWM_SCP2(uint8_t duty_cycle) {
	...
	HAL_StatusTypeDef status = HAL_TIM_PWM_Start(handleSCP1, SCP2_CHANNEL);	// start PWM
	handleSCP1->Instance->CCR1 = duty_cycle;								// set PWM duty cycle
...
HAL_StatusTypeDef SetPWM_SCP3(uint8_t duty_cycle) {
	...
	HAL_StatusTypeDef status = HAL_TIM_PWM_Start(handleSCP1, SCP3_CHANNEL);	// start PWM
	handleSCP1->Instance->CCR3 = duty_cycle;								// set PWM duty cycle
